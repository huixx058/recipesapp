...
import { IngredientAmountComponent } from 'app/entities/ingredient-amount/ingredient-amount.component';
...
describe('Component Tests', () => {
    describe('IngredientAmount Management Component', () => {
        let comp: IngredientAmountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(IngredientAmountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.ingredientAmounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
