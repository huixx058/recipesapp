...
public class MealTypeResourceIntTest {
     ...
     *
     * @see io.github.jhipster.application.repository.search.MealTypeSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchMealType() throws Exception {
        // Initialize the database
        mealTypeRepository.saveAndFlush(mealType);
        when(mockMealTypeSearchRepository.search(queryStringQuery("id:" + mealType.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(mealType), PageRequest.of(0, 1), 1));
        // Search the mealType
