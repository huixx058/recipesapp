...
public class Ingredient implements Serializable {
    ...
    public Ingredient recipees(Set<Recipee> recipees) {
        this.recipees = recipees;
        return this;
    }

    public Ingredient addRecipee(Recipee recipee) {
        this.recipees.add(recipee);
        recipee.getIngredients().add(this);
        return this;
    }

    public Ingredient removeRecipee(Recipee recipee) {
        this.recipees.remove(recipee);
        recipee.getIngredients().remove(this);
        return this;
    }
