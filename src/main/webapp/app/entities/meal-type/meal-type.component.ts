...
export class MealTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.mealTypeService
                ...
                .subscribe(
                    (res: HttpResponse<IMealType[]>) => this.paginateMealTypes(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/meal-type'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateMealTypes(data: IMealType[], headers: HttpHeaders) {
